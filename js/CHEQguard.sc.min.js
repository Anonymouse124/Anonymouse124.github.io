(function () {
  ...
  t.DEFAULTS = {
    ...
    localImages: function () {
      return "/assets/cheq/public/js/revolution/assets/sc/Pic" + Math.round(Math.random() * 134) + ".jpg"
    },
    verify: function (n, t) {
      var i = !1;
      return $.ajax({
  ...
  window.CHEQguard = u;
  window.CHEQguard.Constructor = t;
  n = t.prototype;
  n.init = function () {
    this.initDOM();
    this.initImg();
  ...
  n.initDOM = function () {
    var n = function (n, t) {
      ...
      s = n("div", "slider"), a = n("i", "fa fa-arrow-right sliderIcon"), h = n("span", "sliderText"), u, c;
    e.className = "block";
  ...
  n.initImg = function () {
    ...
    t.setSrc = function () {
      ...
      r && r !== "" || (r = "/assets/cheq/public/js/revolution/assets/sc/" + Math.round(Math.random() * 134) + ".jpg");
